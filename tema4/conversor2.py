...
class Conversor:
    def __init__(self):
        ...
        self.labelCantidad = ttk.Label(self.ventana, text= "Cantidad:")
        self.labelCantidad.grid(row=0, column=0)

        self.cantidad=tk.StringVar(value= "0.0")
        self.entryCantidad=ttk.Entry(self.ventana, width=10, textvariable=self.cantidad)
        self.entryCantidad.grid(column=1, row=0)

        #Seleccion unidades iniciales
        self.initType=tk.IntVar()
        self.radioKelvin=ttk.Radiobutton(self.ventana,text="Kelvin", variable=self.initType, value=0)
        self.radioKelvin.grid(column=0, row=1)
        self.radioCelcius=ttk.Radiobutton(self.ventana,text="Celcius", variable=self.initType, value=1)
        self.radioCelcius.grid(column=1, row=1)
        self.radioFahrenheit=ttk.Radiobutton(self.ventana,text="Fahrenheit", variable=self.initType, value=2)
        self.radioFahrenheit.grid(column=2, row=1)

        #Boton de conversion

        self.ConversionButton=ttk.Button(self.ventana, text="Convertir a:", command=self.calcularConversion)
        ...
        self.check3=ttk.Checkbutton(self.ventana,text="Kelvin", variable=self.finalType[0], onvalue= True)
        self.check3.grid(column=0, row=3)
        self.check3=ttk.Checkbutton(self.ventana,text="Celcius", variable=self.finalType[1], onvalue= True)
        self.check3.grid(column=1, row=3)
        self.check3=ttk.Checkbutton(self.ventana,text="Fahrenheit", variable=self.finalType[2], onvalue= True)
    ...
    def calcularConversion(self):
        ...
        if self.finalType[0].get() == True:
            self.kConversion=ttk.Label(self.ventana, text = "Kelvin")
            ...
            self.finalKelin=ttk.Label(self.ventana, text = self.valorK, foreground= "blue")
            self.finalKelin.grid(column=1, row=nConversiones)
            nConversiones+=1
        
        if self.finalType[1].get() == True:
            self.cConversion=ttk.Label(self.ventana, text = "Celcius")
            ...
            self.finalCelcius=ttk.Label(self.ventana, text = self.valorC, foreground= "blue")
            self.finalCelcius.grid(column=1, row=nConversiones)
            nConversiones+=1

        if self.finalType[2].get() == True:

            self.fConversion=ttk.Label(self.ventana, text = "Fahrenheit")
            ...
            self.finalFahrenheit=ttk.Label(self.ventana, text = self.valorF, foreground= "blue")
