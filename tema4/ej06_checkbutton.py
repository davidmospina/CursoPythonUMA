...
class Aplicacion:
    def __init__(self):
        ...
        self.check1=tk.Checkbutton(self.ventana1,text="Python", variable=self.seleccion1, onvalue = 4)
        self.check1.grid(column=0, row=0)
        
        self.seleccion2=tk.IntVar()
        self.check2=tk.Checkbutton(self.ventana1,text="C++", variable=self.seleccion2, onvalue = 3)
